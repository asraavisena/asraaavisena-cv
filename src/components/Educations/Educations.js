...
export default function Educations() {
  ...
  return (
    ...
    >
      ...
      <div className="container bg-gray-400 mx-auto w-full h-full">
        <div className="relative wrap overflow-hidden px-10 h-full">
          <div
            className="border-2-2 absolute border-opacity-50 border-red-900 min-h-full border"
            style={{ left: "50%" }}
          ></div>
          {/* {educations.map((el, index) => {
            if (index % 2 === 0) {
              return <Education left={""} />;
            } else {
              return <Education index={index} left={"flex-row-reverse"} />;
            }
          })} */}
